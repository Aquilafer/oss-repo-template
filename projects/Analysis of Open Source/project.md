...
Note: I used the FireFox web browser which did not include the extension used 
...
| Community Norms        | 1     | Though I could find no codes of conduct, all forums and sites I browsed showed overwhelmingly friendly language.  |
...
| Community Norms        | 0     | Could not find any significant user community. |
...
| Community Norms        | 0     | Could not find any significant user community. |
| User Base              | 0     | I had significant trouble finding any substantial user base besides the developers. The only evidence of outside interest were from the watch and star counts on the github page. |
...
Nyx by far was the most interesting and the most thorough in terms of support.
Nyx is branch to the open source Tor Project with an OSI approved GNU
General Public License Version 3 [1]. This license ensures that
any new things that branch from Nyx will inherit the GPLv3 license. Nyx
is a command-line monitor for a Tor relay from which one can get detailed data
...
of volunteers and businesses who keep the Tor network moving by hosting
relays for the
...
Nyx's level of activity varied kind of wildly with most activity coming
...
FAQ, there were some mentions of trying to close certain bugs. As far as
I can tell, bugs are investigated quite thoroughly though I did find a mention
...
projects I searched had either small or non-existent communities where Nyx
had by far the largest presence (and by that I mean "any at all"). The truth
is that anyone considering using Nyx probably already has a Tor relay set
